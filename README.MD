# PureCloud Echo Bot template

This sample shows how to create a simple echo bot with state and interact with PureCloud. This bot example uses [`restify`](https://www.npmjs.com/package/restify).

# This bot is not production-ready as the code currently supports only one conversation at a time
...
- Open the purecloud-chat.js file and update the organizationId, deploymentId, queueName and environment
